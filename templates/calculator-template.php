...
<div class="row">
	...
	<div class="col-md-4 text-right last-col">
		<select id="tax_year_is" name="tax_year_is">
			...
			<option value="year2013_14" name="year2013_14" id="year2013_14" <?php if(isset($_POST["tax_year_is"]) && $_POST["tax_year_is"] === "year2013_14"){echo "selected";} ?>>2013/14</option>
...
<div class="row">
	<div class="col-md-7">
		...
		<select id="income_every_x" name="income_every_x">
			<option value="year" <?php if(isset($_POST["income_every_x"]) && $_POST["income_every_x"] === "year"){echo "selected";} ?>>Yearly</option>
			<option value="month" <?php if(isset($_POST["income_every_x"]) && $_POST["income_every_x"] === "month"){echo "selected";} ?>>Monthly</option>
			<option value="week" <?php if(isset($_POST["income_every_x"]) && $_POST["income_every_x"] === "week"){echo "selected";} ?>>Weekly</option>
			<option value="day" <?php if(isset($_POST["income_every_x"]) && $_POST["income_every_x"] === "day"){echo "selected";} ?>>Daily</option>
		</select>
...
<div class="row">
	<div class="col-md-8">
		<select id="pension_every_x" name="pension_every_x">
			<option value="month" <?php if(isset($_POST["pension_every_x"]) && $_POST["pension_every_x"] === "month"){echo "selected";} elseif (!isset($_POST["pension_every_x"])) { echo "selected"; } ?>>Monthly</option>
			<option value="year" <?php if(isset($_POST["pension_every_x"]) && $_POST["pension_every_x"] === "year"){echo "selected";} ?>>Yearly</option>
		</select>
...
<div class="row" id="voucher_extra" <?php if ( !isset( $taxcalc->show_childcare_vouchers ) || $taxcalc->show_childcare_vouchers == 0 ) { echo 'style="display:none"'; } ?>>
	...
	<div class="col-md-2 text-right">
		...
		<?php if(isset($_POST["is_childcare_pre2011"]) && $_POST["is_childcare_pre2011"] === "on"){echo "checked";} ?> >
	</div>
</div>
